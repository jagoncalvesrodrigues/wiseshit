...
class VentaResourceIT {
    ...
    public static Venta createEntity(EntityManager em) {
        Venta venta = new Venta().importe(DEFAULT_IMPORTE).fecha(DEFAULT_FECHA);
        return venta;
    }
    ...
    public static Venta createUpdatedEntity(EntityManager em) {
        Venta venta = new Venta().importe(UPDATED_IMPORTE).fecha(UPDATED_FECHA);
        return venta;
    }
    ...
    void createVenta() throws Exception {
        ...
        assertThat(testVenta.getImporte()).isEqualTo(DEFAULT_IMPORTE);
    ...
    void putNewVenta() throws Exception {
        ...
        updatedVenta.importe(UPDATED_IMPORTE).fecha(UPDATED_FECHA);
        ...
        Venta testVenta = ventaList.get(ventaList.size() - 1);
        assertThat(testVenta.getImporte()).isEqualTo(UPDATED_IMPORTE);
    ...
    void fullUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.importe(UPDATED_IMPORTE).fecha(UPDATED_FECHA);
