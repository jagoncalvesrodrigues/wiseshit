...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().imagen(DEFAULT_IMAGEN).like(DEFAULT_LIKE);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().imagen(UPDATED_IMAGEN).like(UPDATED_LIKE);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getImagen()).isEqualTo(DEFAULT_IMAGEN);
    ...
    void putNewPost() throws Exception {
        ...
        updatedPost.imagen(UPDATED_IMAGEN).like(UPDATED_LIKE);
        ...
        Post testPost = postList.get(postList.size() - 1);
        assertThat(testPost.getImagen()).isEqualTo(UPDATED_IMAGEN);
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.like(UPDATED_LIKE);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.imagen(UPDATED_IMAGEN).like(UPDATED_LIKE);
