...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Sudaderas.class.getName() + ".ventas");
            createCache(cm, com.mycompany.myapp.domain.Accesorios.class.getName());
            createCache(cm, com.mycompany.myapp.domain.Accesorios.class.getName() + ".ventas");
            createCache(cm, com.mycompany.myapp.domain.Venta.class.getName());
            createCache(cm, com.mycompany.myapp.domain.Venta.class.getName() + ".camisetas");
            createCache(cm, com.mycompany.myapp.domain.Venta.class.getName() + ".sudaderas");
            createCache(cm, com.mycompany.myapp.domain.Venta.class.getName() + ".accesorios");
