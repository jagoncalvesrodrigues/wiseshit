...
describe('Component Tests', () => {
  describe('Camisetas Management Component', () => {
    let comp: CamisetasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CamisetasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.camisetas?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
