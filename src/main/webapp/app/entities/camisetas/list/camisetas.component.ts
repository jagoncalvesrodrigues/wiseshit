...
export class CamisetasComponent implements OnInit {
  ...
  delete(camisetas: ICamisetas): void {
    const modalRef = this.modalService.open(CamisetasDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.camisetas = camisetas;
  ...
  protected onSuccess(data: ICamisetas[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
