...
describe('Component Tests', () => {
  describe('Sudaderas Management Component', () => {
    let comp: SudaderasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SudaderasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sudaderas?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
