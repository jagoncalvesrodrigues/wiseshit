...
describe('Component Tests', () => {
  describe('Accesorios Management Component', () => {
    let comp: AccesoriosComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AccesoriosComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.accesorios?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
